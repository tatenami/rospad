...
#include "pad_msg/msg/detail/pad__rosidl_typesupport_fastrtps_c.h"
...
using _Pad__ros_msg_type = pad_msg__msg__Pad;
...
{
  const _Pad__ros_msg_type * ros_message = static_cast<const _Pad__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pad_msg__msg__Pad;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const pad_msg__msg__Pad * ros_message = static_cast<const pad_msg__msg__Pad *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_pad_msg__msg__Pad(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  pad_msg__msg__Pad * ros_message = static_cast<pad_msg__msg__Pad *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_pad_msg__msg__Pad(cdr, ros_message);
}

static uint32_t _Pad__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pad_msg__msg__Pad(
...
static size_t _Pad__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pad_msg__msg__Pad(
...
static message_type_support_callbacks_t __callbacks_Pad = {
  "pad_msg::msg",
  "Pad",
  _Pad__cdr_serialize,
...
static rosidl_message_type_support_t _Pad__type_support = {
