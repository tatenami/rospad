...
static const _Pad_type_support_symbol_names_t _Pad_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pad_msg, msg, Pad)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pad_msg, msg, Pad)),
  }
};
...
{
  return &::pad_msg::msg::rosidl_typesupport_cpp::Pad_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pad_msg, msg, Pad)() {
  return get_message_type_support_handle<pad_msg::msg::Pad>();
}
