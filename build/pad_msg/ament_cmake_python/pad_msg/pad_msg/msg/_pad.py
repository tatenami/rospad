...
class Metaclass_Pad(type):
    """Metaclass of message 'Pad'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('pad_msg')
        except ImportError:
            import logging
            import traceback
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__pad
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__pad
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__pad
            cls._TYPE_SUPPORT = module.type_support_msg__msg__pad
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__pad
...
class Pad(metaclass=Metaclass_Pad):
    """Message class 'Pad'."""
